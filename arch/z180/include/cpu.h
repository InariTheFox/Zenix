...
__sfr __at(Z180_IO_BASE +
           0x0C) TIME_TMDR0L; /* Timer data register,    channel 0L         */
__sfr __at(Z180_IO_BASE +
           0x0D) TIME_TMDR0H; /* Timer data register,    channel 0H         */
__sfr __at(Z180_IO_BASE +
           0x0E) TIME_RLDR0L; /* Timer reload register,  channel 0L         */
__sfr __at(Z180_IO_BASE +
           0x0F) TIME_RLDR0H; /* Timer reload register,  channel 0H         */
__sfr __at(Z180_IO_BASE + 0x10) TIME_TCR; /* Timer control register */
__sfr __at(Z180_IO_BASE +
           0x14) TIME_TMDR1L; /* Timer data register,    channel 1L         */
__sfr __at(Z180_IO_BASE +
           0x15) TIME_TMDR1H; /* Timer data register,    channel 1H         */
__sfr __at(Z180_IO_BASE +
           0x16) TIME_RLDR1L; /* Timer reload register,  channel 1L         */
__sfr __at(Z180_IO_BASE +
           0x17) TIME_RLDR1H; /* Timer reload register,  channel 1H         */
__sfr __at(Z180_IO_BASE + 0x18) TIME_FRC; /* Timer Free running counter */

__sfr __at(Z180_IO_BASE +
           0x00) ASCI_CNTLA0; /* ASCI control register A channel 0          */
__sfr __at(Z180_IO_BASE +
           0x01) ASCI_CNTLA1; /* ASCI control register A channel 1          */
__sfr __at(Z180_IO_BASE +
           0x02) ASCI_CNTLB0; /* ASCI control register B channel 0          */
__sfr __at(Z180_IO_BASE +
           0x03) ASCI_CNTLB1; /* ASCI control register B channel 0          */
__sfr __at(Z180_IO_BASE +
           0x04) ASCI_STAT0; /* ASCI status register    channel 0          */
__sfr __at(Z180_IO_BASE +
           0x05) ASCI_STAT1; /* ASCI status register    channel 1          */
__sfr __at(Z180_IO_BASE +
           0x06) ASCI_TDR0; /* ASCI transmit data reg, channel 0          */
__sfr __at(Z180_IO_BASE +
           0x07) ASCI_TDR1; /* ASCI transmit data reg, channel 1          */
__sfr __at(Z180_IO_BASE +
           0x08) ASCI_RDR0; /* ASCI receive data reg,  channel 0          */
__sfr __at(Z180_IO_BASE +
           0x09) ASCI_RDR1; /* ASCI receive data reg,  channel 0          */
__sfr __at(Z180_IO_BASE +
           0x12) ASCI_ASEXT0; /* ASCI extension register channel 0          */
__sfr __at(Z180_IO_BASE +
           0x13) ASCI_ASEXT1; /* ASCI extension register channel 1          */
__sfr __at(Z180_IO_BASE +
           0x1A) ASCI_ASTC0L; /* ASCI time constant register channel 0 low  */
__sfr __at(Z180_IO_BASE +
           0x1B) ASCI_ASTC0H; /* ASCI time constant register channel 0 high */
__sfr __at(Z180_IO_BASE +
           0x1C) ASCI_ASTC1L; /* ASCI time constant register channel 1 low  */
__sfr __at(Z180_IO_BASE +
           0x1D) ASCI_ASTC1H; /* ASCI time constant register channel 1 high */

__sfr __at(Z180_IO_BASE + 0x0A) CSIO_CNTR; /* CSI/O control/status register */
__sfr __at(Z180_IO_BASE +
           0x0B) CSIO_TRDR; /* CSI/O transmit/receive data register       */
...
extern void     outw(uint8_t addr, uint16_t value);
extern uint16_t inw(uint8_t addr);
